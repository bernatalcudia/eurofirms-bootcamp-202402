...
export const logic: Logic = {
    ...
    createProduct, modifyProduct, removeProduct, retrieveProductDetails, retrieveProducts, retrieveSavedProducts, searchProduct, toggleLikeProduct, toggleSaveProduct,
